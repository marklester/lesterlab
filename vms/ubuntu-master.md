...
```
```
sudo virt-install --name hassio --import --vcpus 4 --ram 4096 --os-variant debian9 --autostart --disk /tank/vms/hassos_ova-4.10.qcow2 --boot loader=/usr/share/qemu-efi/QEMU_EFI.fd
```